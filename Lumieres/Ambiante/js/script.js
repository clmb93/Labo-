...
/* CREATION DE LA SPHERE */
    ...
    /* CREATION DU MATERIEL DE LA SPHERE */
        ...
        var materiel = new THREE.MeshPhongMaterial({color : 0xdb1adb}); //On crée le materiel de notre sphere ici un phong material , il en existe plein d'autre
...
var Lumiere = new   THREE.AmbientLight({color : 0xffffff}); //Création de la lumière ambiante
